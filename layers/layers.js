...
var format_AREAFUNGSIONAL_2 = new ol.format.GeoJSON();
var features_AREAFUNGSIONAL_2 = format_AREAFUNGSIONAL_2.readFeatures(json_AREAFUNGSIONAL_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AREAFUNGSIONAL_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AREAFUNGSIONAL_2.addFeatures(features_AREAFUNGSIONAL_2);
var lyr_AREAFUNGSIONAL_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AREAFUNGSIONAL_2, 
                style: style_AREAFUNGSIONAL_2,
                popuplayertitle: 'AREA FUNGSIONAL',
                interactive: true,
                title: '<img src="styles/legend/AREAFUNGSIONAL_2.png" /> AREA FUNGSIONAL'
            });
...
var group_TITIKAKSESSORIS = new ol.layer.Group({
                                layers: [lyr_Box_Alva_Valve_10,lyr_Bangunan_Air_11,lyr_Bangunan_Sadap_12,lyr_Bangunan_Bagi_13,lyr_Rumah_Pompa_14,],
                                fold: 'open',
...
lyr_GoogleSatellite_0.setVisible(true);lyr_JALAN_1.setVisible(true);lyr_AREAFUNGSIONAL_2.setVisible(true);lyr_JalurPipa_3.setVisible(true);lyr_KETERANGAN_KERUSAKAN_SALURAN_4.setVisible(true);lyr_JENIS_SALURAN_5.setVisible(true);lyr_Tikungan_6.setVisible(true);lyr_Beda_Pasangan_7.setVisible(true);lyr_Gorong__Gorong_8.setVisible(true);lyr_Titik_Per_50_m_9.setVisible(true);lyr_Box_Alva_Valve_10.setVisible(true);lyr_Bangunan_Air_11.setVisible(true);lyr_Bangunan_Sadap_12.setVisible(true);lyr_Bangunan_Bagi_13.setVisible(true);lyr_Rumah_Pompa_14.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_JALAN_1,lyr_AREAFUNGSIONAL_2,lyr_JalurPipa_3,lyr_KETERANGAN_KERUSAKAN_SALURAN_4,lyr_JENIS_SALURAN_5,group_TITIKKETERANGAN,group_TITIKAKSESSORIS];
lyr_JALAN_1.set('fieldAliases', {'NAMRJL': 'NAMRJL', 'KONRJL': 'KONRJL', 'MATRJL': 'MATRJL', 'FGSRJL': 'FGSRJL', 'UTKRJL': 'UTKRJL', 'TOLRJL': 'TOLRJL', 'WLYRJL': 'WLYRJL', 'AUTRJL': 'AUTRJL', 'KLSRJL': 'KLSRJL', 'SPCRJL': 'SPCRJL', 'JPARJL': 'JPARJL', 'ARHRJL': 'ARHRJL', 'STARJL': 'STARJL', 'KLLRJL': 'KLLRJL', 'MEDRJL': 'MEDRJL', 'LOCRJL': 'LOCRJL', 'JARRJL': 'JARRJL', 'FCODE': 'FCODE', 'REMARK': 'REMARK', 'SRS_ID': 'SRS_ID', 'LCODE': 'LCODE', 'METADATA': 'METADATA', 'SHAPE_Leng': 'SHAPE_Leng', });
lyr_AREAFUNGSIONAL_2.set('fieldAliases', {'Id': 'Id', 'KET': 'KET', 'LUAS_HA': 'LUAS_HA', 'LUAS': 'LUAS', });
...
lyr_AREAFUNGSIONAL_2.set('fieldImages', {'Id': 'Range', 'KET': 'TextEdit', 'LUAS_HA': 'TextEdit', 'LUAS': 'TextEdit', });
...
lyr_AREAFUNGSIONAL_2.set('fieldLabels', {'Id': 'hidden field', 'KET': 'hidden field', 'LUAS_HA': 'hidden field', 'LUAS': 'inline label - visible with data', });
...
lyr_Box_Alva_Valve_10.set('fieldLabels', {'NAME': 'inline label - visible with data', 'Descriptio': 'hidden field', 'pdfmaps_ph': 'hidden field', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'BUJUR': 'inline label - visible with data', 'LINTANG': 'inline label - visible with data', 'PANJANG': 'no label', 'FOTO_1': 'no label', 'FOTO_2': 'no label', 'FOTO_3': 'no label', 'FOTO_4': 'no label', 'FOTO_5': 'no label', 'FOTO_6': 'no label', 'FOTO_7': 'no label', 'FOTO_8': 'no label', });
...
lyr_Bangunan_Sadap_12.set('fieldLabels', {'NAME': 'inline label - visible with data', 'Descriptio': 'hidden field', 'pdfmaps_ph': 'hidden field', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'BUJUR': 'inline label - visible with data', 'LINTANG': 'inline label - visible with data', 'PANJANG': 'inline label - visible with data', 'FOTO_1': 'no label', 'FOTO_2': 'no label', 'FOTO_3': 'no label', 'FOTO_4': 'no label', 'FOTO_5': 'no label', 'FOTO_6': 'no label', 'FOTO_7': 'no label', 'FOTO_8': 'no label', });
lyr_Bangunan_Bagi_13.set('fieldLabels', {'NAME': 'inline label - visible with data', 'Descriptio': 'hidden field', 'pdfmaps_ph': 'hidden field', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'BUJUR': 'inline label - visible with data', 'LINTANG': 'inline label - visible with data', 'PANJANG': 'no label', 'FOTO_1': 'no label', 'FOTO_2': 'no label', 'FOTO_3': 'no label', 'FOTO_4': 'no label', 'FOTO_5': 'no label', 'FOTO_6': 'no label', 'FOTO_7': 'no label', 'FOTO_8': 'no label', });
lyr_Rumah_Pompa_14.set('fieldLabels', {'NAME': 'inline label - visible with data', 'Descriptio': 'hidden field', 'pdfmaps_ph': 'hidden field', 'X': 'header label - visible with data', 'Y': 'inline label - visible with data', 'BUJUR': 'inline label - visible with data', 'LINTANG': 'inline label - visible with data', 'PANJANG': 'inline label - visible with data', 'FOTO_1': 'no label', 'FOTO_2': 'no label', 'FOTO_3': 'no label', 'FOTO_4': 'no label', 'FOTO_5': 'no label', 'FOTO_6': 'no label', 'FOTO_7': 'no label', 'FOTO_8': 'no label', });
