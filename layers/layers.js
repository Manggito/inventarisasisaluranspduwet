...
lyr_GoogleSatelliteHybrid_0.setVisible(true);lyr_GoogleSatellite_1.setVisible(true);lyr_GoogleRoads_2.setVisible(true);lyr_OpenTopoMap_3.setVisible(true);lyr_SUNGAI_4.setVisible(true);lyr_JALAN_5.setVisible(true);lyr_AREAFUNGSIONAL_6.setVisible(true);lyr_JalurPipa_7.setVisible(true);lyr_KETERANGAN_KERUSAKAN_SALURAN_8.setVisible(true);lyr_JENIS_SALURAN_9.setVisible(true);lyr_AREA_NOMENKLATUR_10.setVisible(true);lyr_BANGUNAN_NOMENKLATUR_11.setVisible(true);lyr_Tikungan_12.setVisible(true);lyr_Beda_Pasangan_13.setVisible(true);lyr_Gorong__Gorong_14.setVisible(true);lyr_Titik_Per_50_m_15.setVisible(true);lyr_Box_Alva_Valve_16.setVisible(true);lyr_Bangunan_Air_17.setVisible(true);lyr_Bangunan_Sadap_18.setVisible(true);lyr_Bangunan_Bagi_19.setVisible(true);lyr_Rumah_Pompa_20.setVisible(true);
